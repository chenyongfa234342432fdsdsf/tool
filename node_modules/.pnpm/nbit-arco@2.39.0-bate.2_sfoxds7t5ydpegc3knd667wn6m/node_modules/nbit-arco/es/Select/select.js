...
function Select(baseProps, ref) {
    ...
    var renderPopup = function () {
        ...
        // 无选项时的占位符元素
        var eleNoOptionPlaceholder = mergedNotFoundContent && !allowCreate ? (React.createElement("div", { style: dropdownMenuStyle, className: cs(prefixCls + "-popup-inner", dropdownMenuClassName) }, mergedNotFoundContent)) : null;
