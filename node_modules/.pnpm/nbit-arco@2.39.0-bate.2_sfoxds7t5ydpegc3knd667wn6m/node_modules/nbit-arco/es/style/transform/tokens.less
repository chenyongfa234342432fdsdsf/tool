...
@cascader-prefix-cls-rtl: arco-cascader-rtl;
...
@input-color-bg_hover: var(--color-neutral-2);
...
@input-color-bg_error_hover: rgb(var(--warning-2));
...
@checkbox-mask-bg-color-bg: transparent;
...
@radio-mask-bg-color-bg: transparent;
...
@resizebox-split-prefix-cls: arco-resizebox-split;
@resizebox-split-group-prefix-cls: arco-resizebox-split-group;
...
@tabs-box-shadow-radius: 0.25em;
@tabs-color-box-shadow: rgb(var(--primary-6));
...
@tree-select-prefix-cls-rtl: arco-tree-select-rtl;
...
@buy-up-9: rgb(var(--arcoblue-9));
@buy-up-10: #339853;
@buy-up-3: #a3e0ae;
@buy-up-4: #c4efca;
@buy-up-1: #84d095;
@buy-up-7: #339853;
@buy-up-8: rgb(var(--arcoblue-8));
@buy-up-5: #69c17f;
@buy-up-6: #50b16c;
@buy-up-2: #e8ffeb;
...
@sell-down-5: #ed7775;
@sell-down-1: #ffebe8;
@sell-down-8: rgb(var(--arcoblue-8));
@sell-down-6: #e95a5c;
@sell-down-4: #f29590;
@sell-down-3: #f6b3ac;
@sell-down-7: #c2383f;
@sell-down-9: rgb(var(--arcoblue-9));
@sell-down-10: rgb(var(--arcoblue-10));
...
@tips-6: #f1ae3d;
@tips-2: #fffae8;
@tips-9: rgb(var(--arcoblue-9));
@tips-3: #f9e2a1;
@tips-8: rgb(var(--arcoblue-8));
@tips-10: rgb(var(--arcoblue-10));
