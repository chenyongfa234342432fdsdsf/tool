...
@buy-up-9: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-9'));
...
@dark-buy-up-10: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-10'));
...
@dark-buy-up-4: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-4'));
@buy-up-8: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-8'));
...
@dark-sell-down-1: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-1'));
@color-sell-down-4: rgb(var(~'@{arco-cssvars-prefix}-sell-down-4'));
@sell-down-1: rgb(255, 235, 232);
@sell-down-8: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-8'));
@sell-down-6: rgb(233, 90, 92);
@sell-down-4: rgb(242, 149, 144);
@dark-sell-down-10: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-10'));
...
@dark-sell-down-8: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-8'));
@sell-down-9: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-9'));
@dark-sell-down-9: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-9'));
...
@sell-down-10: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-10'));
...
@tips-9: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-9'));
...
@tips-8: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-8'));
@color-tips-3: rgb(var(~'@{arco-cssvars-prefix}-tips-3'));
@dark-tips-1: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-1'));
@color-tips-8: rgb(var(~'@{arco-cssvars-prefix}-tips-8'));
@dark-tips-10: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-10'));
@dark-tips-8: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-8'));
@dark-tips-9: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-9'));
@tips-10: rgb(var(~'@{arco-cssvars-prefix}-arcoblue-10'));
...
@input-color-bg_hover: @color-fill-2;
@input-color-bg_error_hover: @color-warning-2;
@select-color-bg_default_hover: @color-fill-2;
@select-color-bg_error: var(~'@{arco-cssvars-prefix}-color-danger-light-1');
@select-color-bg_error_hover: @color-danger-1;
