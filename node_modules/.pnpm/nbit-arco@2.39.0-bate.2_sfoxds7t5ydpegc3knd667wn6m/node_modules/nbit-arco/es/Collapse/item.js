...
function Item(props, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref }, rest, { className: cs(prefixCls, (_a = {},
        ...
        React.createElement("div", __assign({ role: "button", "aria-disabled": disabled, "aria-expanded": isExpanded, tabIndex: 0, className: cs(prefixCls + "-header", prefixCls + "-header-" + ctx.expandIconPosition, (_b = {},
