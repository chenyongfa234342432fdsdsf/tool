...
export var TransferList = function (props, ref) {
    ...
    var renderListBody = function () {
        ...
        return customList ? (React.createElement("div", { className: baseClassName + "-custom-list" }, customList)) : (React.createElement(List, { bordered: false, paginationInFooter: true, wrapperClassName: baseClassName + "-list", dataSource: itemsToRender, pagination: pagination
