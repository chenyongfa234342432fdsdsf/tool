...
function BackTop(baseProps, ref) {
    ...
    return (React.createElement("div", __assign({}, pickDataAttributes(props), { ref: ref, className: cs("" + prefixCls, (_a = {}, _a[prefixCls + "-rtl"] = rtl, _a), props.className), style: props.style, onClick: scrollToTop }),
