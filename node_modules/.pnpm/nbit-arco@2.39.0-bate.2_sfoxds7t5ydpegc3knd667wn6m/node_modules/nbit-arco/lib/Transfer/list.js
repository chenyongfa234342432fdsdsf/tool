...
var TransferList = function (props, ref) {
    ...
    var renderHeader = function () {
        ...
        return allowClear ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            eleHeaderUnit,
            !disabled && validKeys.length ? (react_1.default.createElement(icon_hover_1.default, { className: baseClassName + "-icon-clear", onClick: clearItems(keysCanBeChecked) },
    ...
    var renderListBody = function () {
        ...
        return customList ? (react_1.default.createElement("div", { className: baseClassName + "-custom-list" }, customList)) : (react_1.default.createElement(List_1.default, { bordered: false, paginationInFooter: true, wrapperClassName: baseClassName + "-list", dataSource: itemsToRender, pagination: pagination
