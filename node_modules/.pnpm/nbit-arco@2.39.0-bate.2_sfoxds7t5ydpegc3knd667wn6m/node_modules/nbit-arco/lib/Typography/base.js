...
function Base(props) {
    ...
    var handleResize = function (entry) {
        ...
        if (contentRect) {
            ...
            var resizeStatus = simpleEllipsis && ellipsisConfig.rows === 1
                ? // CSS single-line ellipsis may expand infinitely in the table，
                    [useEllipsis_1.MEASURE_STATUS.NO_NEED_ELLIPSIS]
                : [useEllipsis_1.MEASURE_STATUS.NO_NEED_ELLIPSIS, useEllipsis_1.MEASURE_STATUS.MEASURE_END];
