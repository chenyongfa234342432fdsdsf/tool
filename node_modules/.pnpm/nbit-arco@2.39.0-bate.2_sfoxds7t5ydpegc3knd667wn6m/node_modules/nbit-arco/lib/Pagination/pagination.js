...
function Pagination(baseProps, ref) {
    ...
    var _d = __read((0, react_1.useState)(propCurrent || defaultCurrent || _defaultCurrent), 2), current = _d[0], setCurrent = _d[1];
    var _e = __read((0, react_1.useState)(propPageSize || defaultPageSize || _defaultPageSize), 2), pageSize = _e[0], setPageSize = _e[1];
    var _f = __read((0, react_1.useState)(propTotal), 2), total = _f[0], setTotal = _f[1];
    var _g = __read((0, react_1.useState)(!!propShowMore), 2), showMore = _g[0], setShowMore = _g[1];
