...
var SliderButton = function (props) {
    ...
    return (react_1.default.createElement(Trigger_1.default, { style: { maxWidth: 350 }, classNames: "zoomInFadeOut", duration: {
        ...
        react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-button", (_a = {}, _a[prefixCls + "-button-active"] = isActive, _a)), onMouseDown: handleMouseDown, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, style: style, role: "slider", "aria-valuemax": props.maxValue, "aria-valuemin": props.minValue, "aria-valuenow": value, "aria-disabled": !!disabled, tabIndex: 0, "aria-valuetext": (0, is_1.isString)(tooltipText) || (0, is_1.isNumber)(tooltipText) ? String(tooltipText) : undefined })));
};
