...
function Switch(baseProps, ref) {
    ...
    return (react_1.default.createElement("button", __assign({ ref: ref, role: "switch", "aria-checked": !!mergedChecked }, extraProps, { style: style, className: classNames, disabled: disabled, onClick: onHandleClick, type: "button" }),
