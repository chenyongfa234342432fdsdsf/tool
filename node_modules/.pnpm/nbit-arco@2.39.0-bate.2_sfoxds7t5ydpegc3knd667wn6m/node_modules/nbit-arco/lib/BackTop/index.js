...
function BackTop(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", __assign({}, (0, pick_1.pickDataAttributes)(props), { ref: ref, className: (0, classNames_1.default)("" + prefixCls, (_a = {}, _a[prefixCls + "-rtl"] = rtl, _a), props.className), style: props.style, onClick: scrollToTop }),
