...
function CarouselArrow(props, ref) {
    ...
    return (react_1.default.createElement("div", { ref: ref, className: arrowClass },
        react_1.default.createElement("div", { className: prefixCls + "-arrow-" + (direction === 'vertical' ? 'top' : 'left'), onClick: prev }, iconPrev),
        react_1.default.createElement("div", { className: prefixCls + "-arrow-" + (direction === 'vertical' ? 'bottom' : 'right'), onClick: next }, iconNext)));
}
