...
function InputNumber(baseProps, ref) {
    ...
    var _c = __read((0, react_1.useState)('defaultValue' in props ? defaultValue : undefined), 2), innerValue = _c[0], setInnerValue = _c[1];
    var value = (function () {
    ...
    var _e = __read((0, react_1.useState)(false), 2), isOutOfRange = _e[0], setIsOutOfRange = _e[1];
    ...
    var getLegalValue = (0, react_1.useCallback)(function (changedValue) {
        ...
        return (0, is_1.isNumber)(finalValue)
            ? (0, is_1.isNumber)(mergedPrecision)
                ? Number((0, utils_1.toFixed)(finalValue, mergedPrecision))
                : finalValue
            : undefined;
    ...
    (0, react_1.useEffect)(function () {
        var _isOutOfRange = ((0, is_1.isNumber)(min) && value < min) || ((0, is_1.isNumber)(max) && value > max);
    ...
    var getDisplayInputValue = function () {
        ...
        if (isUserInputting) {
            ...
            _value = (0, utils_1.toFixed)(value, mergedPrecision);
        }
        else if (value == null) {
            _value = '';
        }
        else {
            _value = (0, utils_1.toSafeString)(value);
        }
    ...
    var inputEventHandlers = {
        onChange: function (value) {
            ...
            if ((0, is_1.isNumber)(+targetValue) || targetValue === '-' || !targetValue || targetValue === '.') {
    ...
    return (react_1.default.createElement(Input_1.default, __assign({ _ignorePropsFromGlobal: true, role: "spinbutton", "aria-valuemax": max, "aria-valuemin": min, "aria-valuenow": value }, (0, omit_1.default)(rest, ['allowClear']), inputEventHandlers, { style: style, className: (0, classNames_1.default)(prefixCls, prefixCls + "-mode-" + mode, prefixCls + "-size-" + mergedSize, (_a = {},
