...
function InputTag(baseProps, ref) {
    ...
    var childrenWithAnimation = value
        ...
        react_1.default.createElement(input_element_1.default, { autoComplete: "off", size: size, disabled: disabled || disableInput, readOnly: readOnly, ref: inputRef, autoFocus: autoFocus, placeholder: !value.length ? placeholder : '', prefixCls: prefixCls + "-input", autoFitWidth: {
    ...
    return (react_1.default.createElement("div", __assign({}, (0, omit_1.default)(rest, ['size', 'defaultValue', 'value', 'inputValue']), { style: style, className: (0, classNames_1.default)(prefixCls, (_a = {},
        ...
        react_1.default.createElement("div", { className: prefixCls + "-view" },
            react_1.default.createElement(UsedTransitionGroup, { prefixCls: prefixCls, animation: animation }, draggable ? (react_1.default.createElement(Draggable_1.default, { itemWrapperStyle: { display: 'inline-block' }, direction: "horizontal", onIndexChange: function (index, prevIndex) {
