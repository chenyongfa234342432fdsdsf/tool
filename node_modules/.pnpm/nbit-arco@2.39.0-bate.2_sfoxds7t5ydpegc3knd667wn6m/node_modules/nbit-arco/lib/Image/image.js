...
function Image(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", { className: classNames, style: Object.assign({ width: width, height: height }, style), ref: ref },
        react_1.default.createElement("img", __assign({ ref: refImg, className: prefixCls + "-img" }, restProps, { title: title, width: width, height: height, onLoad: onImgLoaded, onError: onImgLoadError, onClick: onImgClick, alt: alt })),
