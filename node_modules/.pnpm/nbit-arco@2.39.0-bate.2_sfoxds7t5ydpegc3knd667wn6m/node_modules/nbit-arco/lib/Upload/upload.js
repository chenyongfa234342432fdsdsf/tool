...
var Upload = function (baseProps, ref) {
    ...
    var uploadDom = (react_1.default.createElement("div", __assign({}, (0, omit_1.default)(rest, [
        ...
        react_1.default.createElement(uploader_1.default, __assign({ ref: uploaderRef }, props, { limit: limit.maxCount, hide: limit.hideOnExceedLimit && exceedLimit, disabled: disabledUploadDom, prefixCls: prefixCls, fileList: fileList, onProgress: function (file, e) {
                if (file) {
                    if (!('fileList' in props)) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        showUploadList && (react_1.default.createElement(index_1.default, { progressProps: progressProps, showUploadList: showUploadList, disabled: props.disabled, listType: listType, fileList: fileList, renderUploadItem: renderUploadItem, renderUploadList: renderUploadList, onUpload: uploadFile, onAbort: abortFile, onRemove: removeFile, onReupload: reuploadFile, onPreview: props.onPreview, prefixCls: prefixCls })),
        listType === 'picture-card' && uploadDom,
