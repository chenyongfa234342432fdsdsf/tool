...
var FileList = function (props) {
    ...
    return (react_1.default.createElement(react_transition_group_1.TransitionGroup, { className: (0, classNames_1.default)(prefixCls + "-list", prefixCls + "-list-type-" + listType, (_a = {},
            _a[prefixCls + "-list-rtl"] = rtl,
            _a)) }, fileList.map(function (file) {
        var originNode = listType === 'picture-card' ? (react_1.default.createElement("div", { className: prefixCls + "-list-item " + prefixCls + "-list-item-" + file.status },
            react_1.default.createElement(pictureItem_1.default, __assign({}, props, { file: file })))) : (react_1.default.createElement(textItem_1.default, __assign({}, props, { file: file, locale: locale })));
