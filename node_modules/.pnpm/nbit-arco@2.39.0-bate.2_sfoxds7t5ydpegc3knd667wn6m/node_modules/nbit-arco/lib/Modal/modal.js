...
function Modal(baseProps, ref) {
    ...
    var modalDom = (react_1.default.createElement("div", __assign({ role: "dialog" }, ariaProps, { className: (0, classNames_1.default)(prefixCls, (_a = {},
            _a[prefixCls + "-simple"] = simple,
            _a[prefixCls + "-rtl"] = rtl,
            _a), className), style: style }), innerFocusLock ? (react_1.default.createElement(react_focus_lock_1.default, { disabled: !visible, autoFocus: innerAutoFocus, lockProps: {
            tabIndex: -1,
            onKeyDown: onEscExit,
        } }, element)) : (element)));
