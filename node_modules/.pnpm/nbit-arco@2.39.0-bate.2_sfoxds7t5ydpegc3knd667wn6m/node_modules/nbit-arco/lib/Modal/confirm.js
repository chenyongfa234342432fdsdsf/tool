...
function confirm(config, renderFunc) {
    ...
    function render(props) {
        react_dom_1.default.render(react_1.default.createElement(ConfigProvider_1.default, __assign({}, configProviderProps),
            react_1.default.createElement(ConfirmModal, __assign({}, props, { onCancel: onCancel }))), div);
    }
