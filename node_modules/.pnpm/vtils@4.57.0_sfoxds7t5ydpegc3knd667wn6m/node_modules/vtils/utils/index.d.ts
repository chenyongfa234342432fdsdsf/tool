...
/**
 ...
 @see Split
 */
declare type CamelCaseStringArray<Parts extends readonly string[]> =
...
/**
 ...
 @category Template Literals
 */
declare type DelimiterCase<Value, Delimiter extends string> = Value extends string
 ...
 */
declare type InnerCamelCaseStringArray<Parts extends readonly any[], PreviousPart> =
	Parts extends [`${infer FirstPart}`, ...infer RemainingParts]
...
/**
 ...
 @category Template Literals
 */
declare type PascalCase<Value> = CamelCase<Value> extends string
