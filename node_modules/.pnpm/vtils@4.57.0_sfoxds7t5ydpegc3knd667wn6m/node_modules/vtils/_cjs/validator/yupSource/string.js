...
(0, _inherits.default)(StringSchema, _mixed.default, {
  ...
  chineseIDCardNumber: function chineseIDCardNumber(message) {
    if (message === void 0) {
      message = _locale.string.chineseIDCardNumber;
    }

    return this.test({
      message: message,
      name: 'chineseIDCardNumber',
      test: _utils.isChineseIDCardNumber
    });
  },
  chineseMobilePhoneNumber: function chineseMobilePhoneNumber(message) {
    if (message === void 0) {
      message = _locale.string.chineseMobilePhoneNumber;
    }

    return this.test({
      message: message,
      name: 'chineseMobilePhoneNumber',
      test: _utils.isPossibleChineseMobilePhoneNumber
    });
  },
  //-- transforms --
