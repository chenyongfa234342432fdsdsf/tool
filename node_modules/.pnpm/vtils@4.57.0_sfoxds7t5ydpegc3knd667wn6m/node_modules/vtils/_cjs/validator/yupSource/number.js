...
(0, _inherits.default)(NumberSchema, _mixed.default, {
  ...
  positiveInteger: function positiveInteger(msg) {
    if (msg === void 0) {
      msg = _locale.number.positiveInteger;
    }
  ...
  negativeInteger: function negativeInteger(msg) {
    if (msg === void 0) {
      msg = _locale.number.negativeInteger;
    }
  ...
  nonPositive: function nonPositive(msg) {
    if (msg === void 0) {
      msg = _locale.number.nonPositive;
    }
    ...
    return this.test({
      ...
      exclusive: true,
      test: function test(val) {
        return (0, _isAbsent.default)(val) || val <= 0;
      }
    });
  },
  nonNegative: function nonNegative(msg) {
    if (msg === void 0) {
      msg = _locale.number.nonNegative;
    }
  ...
  nonPositiveInteger: function nonPositiveInteger(msg) {
    if (msg === void 0) {
      msg = _locale.number.nonPositiveInteger;
    }
    ...
    return this.test({
      ...
      exclusive: true,
      test: function test(val) {
        return (0, _isAbsent.default)(val) || Number.isInteger(val) && val <= 0;
      }
    });
  },
  nonNegativeInteger: function nonNegativeInteger(msg) {
    if (msg === void 0) {
      msg = _locale.number.nonNegativeInteger;
    }
