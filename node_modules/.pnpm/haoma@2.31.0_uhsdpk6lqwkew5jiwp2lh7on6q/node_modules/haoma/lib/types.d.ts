...
export declare type JestConfig = Partial<jest.Config.InitialOptions> & {
    /**
     * 要转换的包的名称列表。
     *
     * @example ['lodash-es']
...
export declare type BabelConfigDynamicallyItem<T> = T | ((file: string) => T);
export interface BabelConfig extends babel.TransformOptions {
    ...
    bus?: EventBus<{
        addAfterWriteTransformer: (transformer: (content: string) => AsyncOrSync<string>) => any;
    }>;
}
...
export declare type CompileCliConfig = CompileConfig | CompileConfig[];
